...
import { O as LoaderCircle, T as Car, c as Smartphone, i as Users, m as Navigation, n as X, p as Package, r as Wallet, u as Search, x as CreditCard, y as Lock } from "../_libs/lucide-react.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/book-SglQZzD4.js
...
function BookPage() {
	...
	async function confirmRide() {
		...
		try {
			...
			const price = +(basePrice * CAR_CLASSES.find((c) => c.id === carClass).mult).toFixed(2);
