...
import { t as Route } from "./track._rideId-CiCKYor-.js";
...
import { Car, Loader2, MessageSquare, Phone, Search, Shield } from "lucide-react";
//#region src/lib/osrm.ts
...
//#endregion
//#region src/routes/_authenticated/track.$rideId.tsx?tsr-split=component
var SPEED_KMH = 45;
...
function TrackPage() {
	...
	if (!ride) return /* @__PURE__ */ jsx(AppShell, {
		active: "book",
	...
	if (ride.status === "pending") return /* @__PURE__ */ jsxs(AppShell, {
		active: "book",
		children: [/* @__PURE__ */ jsx(RideMap, {
			center: pickup,
			pickup,
			destination: dest,
			drivers: [],
			...
			children: [/* @__PURE__ */ jsx("div", { className: "mx-auto mt-2 h-1 w-10 rounded-full bg-border" }), /* @__PURE__ */ jsxs("div", {
			...
			children: [/* @__PURE__ */ jsx("div", { className: "mx-auto mt-2 h-1 w-10 rounded-full bg-border" }), /* @__PURE__ */ jsxs("div", {
				...
				children: [
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							/* @__PURE__ */ jsx("div", {
								...
								children: /* @__PURE__ */ jsx(Car, { className: "h-5 w-5" })
							}),
							/* @__PURE__ */ jsxs("div", {
								className: "flex-1",
								children: [/* @__PURE__ */ jsx("p", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx(Shield, { className: "h-4 w-4 text-primary" }), "Trip is being tracked. Share your ETA with a trusted contact."]
					}),
					ride.status === "completed" && /* @__PURE__ */ jsx(Button, {
						onClick: () => navigate({ to: "/history" }),
