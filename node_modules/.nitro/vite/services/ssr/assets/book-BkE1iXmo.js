import { t as getServerFnById } from "./__23tanstack-start-server-fn-resolver-D6UZ2-Kv.js";
import { i as createServerFn, p as TSS_SERVER_FUNCTION } from "./esm-Dova13aH.js";
import { t as supabase } from "./client-F__N42p1.js";
import { t as AppShell } from "./AppShell-D5kbQcWh.js";
import { t as Button } from "./button-DRsC1qZi.js";
import { n as pushNotify, r as RideMap, t as ensureNotificationPermission } from "./notifications-C7Po_pgf.js";
...
import { Car, CreditCard, Loader2, Lock, Navigation, Package, Search, Smartphone, Users, Wallet, X } from "lucide-react";
...
//#endregion
//#region src/lib/maps.functions.ts
...
//#endregion
//#region src/routes/_authenticated/book.tsx?tsr-split=component
var DEFAULT_CENTER = {
	lat: 6.5244,
	lng: 3.3792
};
...
function BookPage() {
	...
	const [focusField, setFocusField] = useState("destination");
	...
	return /* @__PURE__ */ jsxs(AppShell, {
		...
		children: [
			...
			/* @__PURE__ */ jsxs("div", {
				...
				children: [/* @__PURE__ */ jsx("div", { className: "mx-auto mt-2 h-1 w-10 rounded-full bg-border" }), /* @__PURE__ */ jsx("div", {
					...
					children: !ready ? /* @__PURE__ */ jsxs(Fragment, { children: [
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [/* @__PURE__ */ jsxs("div", {
								...
								children: [/* @__PURE__ */ jsx("div", { className: "h-2.5 w-2.5 rounded-full bg-foreground" }), /* @__PURE__ */ jsx(Input, {
								...
								className: "flex items-center gap-3 rounded-2xl bg-surface-elevated px-3 py-2.5",
								children: [/* @__PURE__ */ jsx("div", { className: "h-2.5 w-2.5 rounded-sm bg-primary" }), /* @__PURE__ */ jsx(Input, {
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								search.isPending && /* @__PURE__ */ jsxs("div", {
									className: "flex items-center gap-2 px-1 py-3 text-sm text-muted-foreground",
									children: [/* @__PURE__ */ jsx(Loader2, { className: "h-4 w-4 animate-spin" }), " Searching…"]
								}),
								!search.isPending && results.length === 0 && query.length < 3 && /* @__PURE__ */ jsx("p", {
								...
								results.map((r) => /* @__PURE__ */ jsxs("button", {
									...
									children: [/* @__PURE__ */ jsx(Search, { className: "mt-0.5 h-4 w-4 shrink-0 text-muted-foreground" }), /* @__PURE__ */ jsx("span", {
										className: "text-sm",
										children: r.address
									})]
								}, `${r.lat}-${r.lng}`))
						...
						/* @__PURE__ */ jsxs("div", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: "ml-[5px] h-3 w-px bg-border" }),
								/* @__PURE__ */ jsx(Row, {
									...
									children: [/* @__PURE__ */ jsx("div", {
										...
										children: [/* @__PURE__ */ jsxs("div", {
											...
											children: [/* @__PURE__ */ jsxs("span", { children: [
												...
												duration,
												" min"
											] }), /* @__PURE__ */ jsxs("span", { children: [c.eta, " min away"] })]
										})]
									})]
								}, c.id);
							})
			...
			checkoutOpen && ready && /* @__PURE__ */ jsx(CheckoutSheet, {
...
function CheckoutSheet({ total, method, setMethod, onClose, onPay, loading }) {
	return /* @__PURE__ */ jsx("div", {
		...
		children: /* @__PURE__ */ jsxs("div", {
			...
			children: [
				/* @__PURE__ */ jsx("div", { className: "mx-auto mb-3 h-1 w-10 rounded-full bg-border" }),
				/* @__PURE__ */ jsxs("div", {
					className: "flex items-center justify-between",
					...
					children: [
						...
						return /* @__PURE__ */ jsxs("button", {
							...
							children: [
								...
								/* @__PURE__ */ jsx("div", { className: `h-4 w-4 rounded-full border ${selected ? "border-primary bg-primary" : "border-border"}` })
							]
						}, m.id);
					})
				}),
				...
				/* @__PURE__ */ jsx(Button, {
					...
					disabled: loading,
					className: "mt-4 h-12 w-full rounded-2xl bg-primary text-base font-semibold text-primary-foreground hover:bg-primary/90",
					children: loading ? /* @__PURE__ */ jsx(Loader2, { className: "h-5 w-5 animate-spin" }) : /* @__PURE__ */ jsxs(Fragment, { children: [
...
function Row({ dot, text, onClear }) {
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [
			/* @__PURE__ */ jsx("div", { className: `h-2.5 w-2.5 ${dot.includes("square") ? "rounded-sm bg-primary" : "rounded-full bg-foreground"}` }),
			/* @__PURE__ */ jsx("span", {
